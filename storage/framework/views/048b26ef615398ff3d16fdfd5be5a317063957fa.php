        ...
        <?php $__currentLoopData = $produit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="card">
            <div class="card-header">
              <h5><?php echo e($item->id); ?>-<?php echo e($item->refprod); ?>-<?php echo e($item->prod); ?></h5>
            </div>
            <div class="card-body">
            <?php echo DNS2D::getBarcodeHTML($item->id."-".$item->refprod."-".$item->prod."-".$item->puach, 'QRCODE'); ?>
...
<?php /**PATH C:\Users\hp\Downloads\Mes projets\Laravel\MaComptabilite\MaComptabilite\resources\views/produit/prodscanpdf.blade.php ENDPATH**/ ?>