  ...
  <div class="card-body">
    ...
    <div class="row align-items-center">  
      <form action="<?php echo e(url('cotficemp')); ?>" method="post">
        ...
        <div class="col-md-4">
        <label>I.S.</label>
        <input type="number" name="is" id="idis" class="form-control" value="0">
        </div>
        <div class="col-md-4">
        <label>C.N.</label>
        <input type="number" name="cn" id="idcn" class="form-control" value="0">
        </div>
        <div class="col-md-4">
        <label>I.G.R.</label>
        <input type="number" name="igr" id="idigr" class="form-control" value="0">
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <br/>
                    <form action = "<?php echo e(url('getcotficemp')); ?>" method = "POST">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\Mes projets\Laravel\MaComptabilite\MaComptabilite\resources\views/cotficemp/index.blade.php ENDPATH**/ ?>