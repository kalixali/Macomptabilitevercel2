...
<?php $__env->startSection('content'); ?>
 ...
 <div class="card">
  ...
  <div class="card-body">
     ...
     <div class="row align-items-center">  
      <form action="<?php echo e(url('achats')); ?>" method="post">
        ...
        <input type="text" name="numfact" id="numfact" class="inputbcolor form-control" autocomplete="off" value="<?php echo e($acha->numfact); ?>">
        <div id="facture_list"> </div>
        </div>
        <div class="col-md-6">
        <label>Fournisseur</label>
        <input type="text" name="siglefourn" id="siglefourn" class="form-control" autocomplete="off" value="<?php echo e($acha->siglefourn); ?>">
  ...
  <div class="table-responsive">
        ...
        <br/>
        <div class="row">
            <form action="<?php echo e(url('/achatscan')); ?>" method="GET">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\Mes projets\Laravel\MaComptabilite\MaComptabilite\resources\views/achats/achatscan1.blade.php ENDPATH**/ ?>