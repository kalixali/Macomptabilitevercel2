  ...
  <div class="card-body">
    ...
    <div class="row align-items-center">  
      <form action="<?php echo e(url('entstock')); ?>" method="post">
        ...
        <div class="col-md-4">
        <label>Article</label>
        <input type="text" name="prod" id="prod" class="form-control" value="<?php echo e($produit->prod); ?>">
        </div>
        <div class="col-md-4">
        <label>QTITE</label>
        ...
        <div class="col-md-4">
        <label>PU</label>
        <input type="text" name="pu" id="idpu" class="form-control" value="<?php echo e($produit->puach); ?>" autocomplete="off">
        </div>
        <div class="col-md-4">
        <label>Montant</label>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\Mes projets\Laravel\MaComptabilite\MaComptabilite\resources\views/entstock/index1.blade.php ENDPATH**/ ?>