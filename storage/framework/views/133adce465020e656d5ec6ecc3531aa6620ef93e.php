...
<?php $__env->startSection('content'); ?>
 ...
 <div class="container text-center">
  ...
  <div class="card-body">
    ...
    <form action = "<?php echo e(url('employes')); ?>" method = "POST" enctype = "multipart/form-data">
            ...
            <!-- <div class="col-md-12"> -->
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <table class="table">
                                ...
                                <?php $__currentLoopData = $employes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><img src="<?php echo e(asset($item->photo)); ?>" width= '50' height= '50' ></td>
                                                                                 
                                        <td>
                                            
                                        <!--    <a href="<?php echo e(url('/employes/' . $item->id . '/edit')); ?>" title="Edit EMPLOYES"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> -->
 
                                            <form method="POST" action="<?php echo e(url('/employes' . '/' . $item->id)); ?>" accept-charset="UTF-8" style="display:inline">
                        ...
                        <form action = "<?php echo e(url('EmployesPDF2')); ?>" method = "POST" enctype = "multipart/form-data">
                        <?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\Mes projets\Laravel\MaComptabilite\MaComptabilite\resources\views/employes/index.blade.php ENDPATH**/ ?>