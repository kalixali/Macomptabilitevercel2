        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <form action = "<?php echo e(url('downloadPDFcpteresultat')); ?>" method = "POST">
                        <?php echo e(csrf_field()); ?>

                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="hidden" name="from_date" class="form-group" value="<?php echo e($exec3); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="hidden" name="to_date" class="form-group" value="<?php echo e($exec4); ?>">
                                </div>
                            </div>
                        </div>
                        <br/>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\Mes projets\Laravel\MaComptabilite\MaComptabilite\resources\views/cpteresultat/index1.blade.php ENDPATH**/ ?>