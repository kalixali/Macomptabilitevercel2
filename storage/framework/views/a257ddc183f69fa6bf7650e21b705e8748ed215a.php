...
<?php $__env->startSection('content'); ?>
 ...
 <div class="container">
  ...
  <div class="card-body">
    ...
    <div class="row">
        <form action="<?php echo e(url('search1')); ?>" method="post">
        <?php echo csrf_field(); ?>
    ...
    <div class="row align-items-center">  
      <form action="<?php echo e(url('cotsocemp')); ?>" method="post">
        ...
        <input type="number" name="cr" id="idcr" class="form-control" value="0">
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                     ...
                     <form action = "<?php echo e(url('getcotsocemp')); ?>" method = "POST">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\Mes projets\Laravel\MaComptabilite\MaComptabilite\resources\views/cotsocemp/index.blade.php ENDPATH**/ ?>