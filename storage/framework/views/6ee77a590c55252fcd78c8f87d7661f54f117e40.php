...
<?php $__env->startSection('content'); ?>
 ...
 <div class="container">
  ...
  <div class="card-body">
    ...
    <div class="row">
        <form action="<?php echo e(url('searchsal')); ?>" method="post">
        <?php echo csrf_field(); ?>
    ...
    <div class="row">
        <form action="<?php echo e(url('downloadPDFsal')); ?>" method="post">
        <?php echo csrf_field(); ?>
    ...
    <div class="row align-items-center">  
      <form action="<?php echo e(url('salaire')); ?>" method="post">
        <?php echo csrf_field(); ?>
        ...
        <div class="row gy-2 px-3 py-3 mx-3 my-3 border border-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="matricule" class="form-control" value="<?php echo e($emp->matricule); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Nom </label>
                                    <input type="text" name="nom" class="form-control" value="<?php echo e($emp->nom); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Prénoms</label>
                                    <input type="text" name="prenoms" class="form-control"  value="<?php echo e($emp->prenoms); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Poste</label>
                                    <input type="text" name="poste" class="form-control" value="<?php echo e($emp->poste); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Catégorie</label>
                                    <input type="text" name="categ" class="form-control" value="<?php echo e($emp->categ); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Nbre part</label>
                                    <input type="number" name="nbrepart" id="nbrepart" class="form-control" value="<?php echo e($emp->nbrepart); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Salaire de base</label>
                                    <input type="number" name="salbase" id="salbase" class="form-control" value="<?php echo e($emp->salbase); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Sursalaire</label>
                                    <input type="number" name="sursal" id="sursal" class="form-control" value="<?php echo e($emp->sursal); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <input type="hidden" name="nation" id="nation" class="form-control" value="<?php echo e($emp->nation); ?>">
                                </div>
                            </div>
                        ...
                        <div class="row gy-2 px-3 py-3 mx-3 my-3 border border-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="avg_logement" id="avg_logement" class="form-control" value="<?php echo e($emp->avg_logement); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Vehicule</label>
                                    <input type="number" name="avg_vehicule" id="avg_vehicule" class="form-control" value="<?php echo e($emp->avg_vehicule); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Autres avantages</label>
                                    <input type="number" name="avg_otr" id="avg_otr" class="form-control" value="<?php echo e($emp->avg_otr); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row gy-2 px-3 py-3 mx-3 my-3 border border-3">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="prime_ancien" id="prime_ancien" class="form-control" value="<?php echo e($emp->prime_ancien); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="prim_risq" id="prim_risq" class="form-control" value="<?php echo e($emp->prim_risq); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="prime_otr" id="prime_otr" class="form-control" value="<?php echo e($emp->prime_otr); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="txhorair" id="txhorair" class="form-control" value="<?php echo e($emp->txhorair); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row gy-2 px-3 py-3 mx-3 my-3 border border-3">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="ind_nourriture" id="ind_nourriture" class="form-control" value="<?php echo e($emp->ind_nourriture); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Indemnite de logement</label>
                                    <input type="number" name="ind_logement" id="ind_logement" class="form-control" value="<?php echo e($emp->ind_logement); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Autres Indemnites Taxables</label>
                                     <input type="number" name="ind_otrtax" id="ind_otrtax" class="form-control" value="<?php echo e($emp->ind_otrtax); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row gy-2 px-3 py-3 mx-3 my-3 border border-3">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="ind_trsport" id="ind_trsport" class="form-control" value="<?php echo e($emp->ind_trsport); ?>">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Indemnite de salissure</label>
                                    <input type="number" name="ind_salissure" id="ind_salissure" class="form-control" value="<?php echo e($emp->ind_salissure); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Autres Indemnites</label>
                                     <input type="number" name="ind_otr" id="ind_otr" class="form-control" value="<?php echo e($emp->ind_otr); ?>">
                                </div>
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action = "<?php echo e(url('getsalaire')); ?>" method = "POST">
                    ...
                    <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                <?php $__currentLoopData = $salaire; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                    ...
                                    <td>
                                        ...
                                        <!--    <a href="<?php echo e(url('/salaire/' . $item->id . '/edit')); ?>" title="Edit emp brut imp."><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a> -->
 
                                            <form method="POST" action="<?php echo e(url('/salaire' . '/' . $item->id)); ?>" accept-charset="UTF-8" style="display:inline">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\Mes projets\Laravel\MaComptabilite\MaComptabilite\resources\views/salaire/index1.blade.php ENDPATH**/ ?>