...
<?php $__env->startSection('content'); ?>
  ...
  <div class="card-body">
     ...
     <div class="row align-items-center">  
      <form action="<?php echo e(url('ventes')); ?>" method="post">
        ...
        <input type="text" name="numfact" id="numfact" class="form-control" value="<?php echo e($vent->numfact); ?>">
 ...
 <div class="table-responsive">
        ...
        <br/>
        <div class="row">
            <form action="<?php echo e(url('/ventes')); ?>" method="GET">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\Mes projets\Laravel\MaComptabilite\MaComptabilite\resources\views/ventes/index1.blade.php ENDPATH**/ ?>