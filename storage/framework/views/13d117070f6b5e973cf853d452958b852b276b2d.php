                    ...
                    <div class="table-responsive">
                            <table class="table">
                                ...
                                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($item->sigleclt); ?></td>
                                        <td><?php echo e($item->client); ?></td>
                                        <td><?php echo e($item->contactc1); ?></td>
                                        <td><?php echo e($item->contactc2); ?></td>
                                        <td><?php echo e($item->emailc); ?></td>
                                    <td>
                                        <a href="<?php echo e(url('/clients/' . $item->id . '/edit')); ?>" title="Edit Clients"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                        <form method="POST" action="<?php echo e(url('/clients' . '/' . $item->id)); ?>" accept-charset="UTF-8" style="display:inline">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\Mes projets\Laravel\MaComptabilite\MaComptabilite\resources\views/clients/index.blade.php ENDPATH**/ ?>