...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <th><?php echo e($totfact[0]->Tmont); ?></th>
        </tr>
        <tr>
            <th colspan="2">TOTAL TVA</th>
            <th><?php echo e($totfact[0]->Tmtva); ?></th>
        </tr>
        <tr>
            <th colspan="2">TOTAL TTC</th>
            <th><?php echo e($totfact[0]->Tvmttc); ?></th>
        </tr>      
        </tbody>
        </table>
        </div>
    ...
    <?php /**PATH C:\Users\hp\Downloads\Mes projets\Laravel\MaComptabilite\MaComptabilite\resources\views/ventes/facturepdf.blade.php ENDPATH**/ ?>