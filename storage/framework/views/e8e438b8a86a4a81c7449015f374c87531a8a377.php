 ...
 <div class="container">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <form action = "<?php echo e(url('downloadPDF2')); ?>" method = "POST" >
    ...
    <script>
        $(document).ready(function() {
            $("#from_matricule").on('keyup', function() {
                var value = $(this).val();
                $.ajax({
                    url: "<?php echo e(route('searchfromat')); ?>",
                    type: "GET",
                    data: {'mat1' : value},
...
<script>
        ...
        $(document).ready(function() {
            $("#to_matricule").on('keyup', function() {
                var value = $(this).val();
                $.ajax({
                    url: "<?php echo e(route('searchtomat')); ?>",
                    type: "GET",
                    data: {'mat2' : value},
                    success: function(data){
                        $("#mat_listo").html(data);
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Downloads\Mes projets\Laravel\MaComptabilite\MaComptabilite\resources\views/bulletin/index.blade.php ENDPATH**/ ?>